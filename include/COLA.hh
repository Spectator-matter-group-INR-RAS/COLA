...
namespace cola {
    ...
    */
    ...
    inline cola::MetaData cola::MetaProcessor::parseStrToMeta(const std::string data) {
        ...
        std::string trimmedData = boost::trim_copy_if(data, boost::is_any_of(fltSeparator.c_str()));
        boost::split(filters, trimmedData, boost::is_any_of(fltSeparator.c_str()), boost::token_compress_on);
